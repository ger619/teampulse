...
import { getMoods, createMood, updateMood, deleteMood } from "../../api/moodWorkloadService";
...
const MoodManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingMood) {
        await updateMood(editingMood.id, data);
      } else {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Excellent, Good, Okay"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#A0D6C2] outline-none"
              />
            </div>
        ...
        <div className="space-y-2">
          {moods.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
              No moods yet. Create your first mood!
            </div>
          ) : (
            moods
              ...
              .map((mood) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-[#A0D6C2] flex items-center justify-center text-white font-bold text-xl">
                      {mood.value}
                    </div>
                    <div>
